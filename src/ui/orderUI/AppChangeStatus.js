...
import AppRadio from "../formUI/AppRadio";
...
export default (
    ...
    return (
        <View style={styles.wrap}>
            ...
            >
                <AppTextBold style={{...styles.statusText, color: color}}>
                                ...
                                data.map(item => {
                                    return <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            ...
                                            //setOpen(false)
                                            globalAlert({
                                               title: "Статус был успешно изменен",
                                               text: "Для применения настроке нужно применить изменения"
                                            })
                                        }}
                                    >
                                        <View
