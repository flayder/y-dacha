...
import {FAVORITE_DECORATOR, FAVORITE_SORT, LinkTo} from "../../../global";
        ...
        <View style={styles.wrap}>
            ...
            <Item>
                <TouchableOpacity activeOpacity={1} style={styles.link} onPress={() => {
                    //console.log('to Comment', route.params)
