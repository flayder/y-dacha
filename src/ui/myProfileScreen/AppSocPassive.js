...
export default ({data = {}, color = "#75AEA4"}) => {
    return (
        <View style={styles.wrap}>
            ...
            <View style={styles.valueWrap}>
                {
                    data.hasOwnProperty('social_vkotakte')
                        ?
                        <View style={styles.value}>
                            ...
                            <View style={styles.textWrap}>
                                <TouchableOpacity
                                    ...
                                    activeOpacity={1}
                                    onPress={async () => {
                                        await WebBrowser.openBrowserAsync(data.social_vkotakte)
                                    }}
                                >
                ...
                {/*Youtube*/}
                {
                    data.hasOwnProperty('social_youtube')
                        ?
                        <View style={styles.value}>
                            <View style={styles.icon}>
                            ...
                            <View style={styles.textWrap}>
                                <TouchableOpacity
                                    ...
                                    activeOpacity={1}
                                    onPress={async () => {
                                        await WebBrowser.openBrowserAsync(data.social_youtube)
                                    }}
                                >
                                    <AppTextTicker style={styles.textWrap}>
                ...
                {/*Insta*/}
                {
                    data.hasOwnProperty('social_instagram')
                        ?
                        <View style={styles.value}>
                            <View style={styles.icon}>
                ...
                {/*Twit*/}
                {
                    data.hasOwnProperty('social_twitter')
                        ?
                        <View style={styles.value}>
                            <View style={styles.icon}>
                ...
                {/*fb*/}
                {
                    data.hasOwnProperty('social_facebook')
                        ?
                        <View style={styles.value}>
                            <View style={styles.icon}>
                                <Svg width="17" height="18" viewBox="0 0 17 18" fill="none"
                            ...
                            <View style={styles.textWrap}>
                                <TouchableOpacity
                                    ...
                                    activeOpacity={1}
                                    onPress={async () => {
                                        await WebBrowser.openBrowserAsync(data.social_facebook)
                                    }}
                                >
                                    <AppTextTicker style={styles.textWrap}>
                ...
                {/*ok*/}
                {
                    data.hasOwnProperty('social_odnoklasniki')
                        ?
                        <View style={styles.value}>
                            <View style={styles.icon}>
                            ...
                            <View style={styles.textWrap}>
                                <TouchableOpacity
                                    ...
                                    activeOpacity={1}
                                    onPress={async () => {
                                        await WebBrowser.openBrowserAsync(data.social_odnoklasniki)
                                    }}
                                >
                                    <AppTextTicker style={styles.textWrap}>
                                        Открыть страницу ОК
