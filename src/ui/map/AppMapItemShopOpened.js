...
export default ({data, route, navigation, onPress}) => {
    const imgStyle = Platform.OS == "android" ? {
        width: 50,
        height: 50,
        borderRadius: 20,
    ...
    const viewStyle = Platform.OS == "android" ? {
        width: 70,
        height: 70,
        marginLeft: 5,
        marginTop: -15,
    ...
    return (
        <View style={styles.balloonWrapGen}>
            <View style={styles.balloonWrap}>
                <View style={styles.balloonHeader}>
                    <Text style={{...styles.balloonAvaWrap, ...viewStyle}}>
                        <AppFastImage
                            style={{...styles.balloonAva, ...imgStyle}}
                            resizeMode={'stretch'}
                            uri={data.emblem}
                        />
                    </Text>
                ...
                <View style={styles.balloonBody}>
                    {
                        data.description
                            ?
                            <AppText style={styles.balloonDescr}>
                                {data.description}
                            </AppText>
                            :
                            <></>
...

                    {
                        data.hasOwnProperty('info')
                            ...
                            <AppText style={{marginBottom: 0, fontSize: 14}}>
                                <AppTextBold style={{fontSize: 14}}>Продавец </AppTextBold>
                    ...
                    <View style={styles.balloonSocial}>
                        ...
                        {
                            data.hasOwnProperty('info') && data.info.hasOwnProperty('site') && data.info.site
                                ?
                                <View style={styles.line}>
                                    <View style={styles.icon}>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        activeOpacity={1}
                                        onPress={async () => {
                                            await Linking.openURL(data.info.site);
                                        }}
                                    >
